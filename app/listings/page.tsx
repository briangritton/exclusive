  ...
  useEffect(() => {
    ...
    const loadWidget = () => {
      ...
      if (ihfKestrel && ihfKestrel.render && containerRef.current) {
        try {
          // Render SEO page - iHomefinder auto-detects /listings from URL
        ...
        if (attempts < maxAttempts) {
          ...
          setError('Property listings temporarily unavailable');
          setLoading(false);
        }
      }
    };
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">
          Browse all available properties in Northern California
        </p>
      </div>
      ...
      {/* Widget container */}
      <div className="ihf-widget-isolation" ref={containerRef} id="listing-results-container"></div>
    </div>
  );
}
